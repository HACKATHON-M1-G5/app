        ...
        <div class="card bg-base-100 shadow-xl border border-red-900/30">
          <div class="card-body">
            ...
            <div class="alert alert-warning mb-4">
              ...
              <span>⚠️ Cette action est définitive. Les tokens seront distribués aux gagnants.</span>
            </div>
                  ...
                  <div class="flex justify-between items-center">
                    <div class="flex-1">
                      ...
                      <p v-if="betStats[bet.id]" class="text-sm mt-1">
                        💰 {{ betStats[bet.id].totalAmount }} tokens misés par {{ betStats[bet.id].betCount }} utilisateur(s)
                      </p>
                    </div>
