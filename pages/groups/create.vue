          ...
          <form @submit.prevent="handleCreateTeam">
            ...
            <div class="mt-4">
              ...
              <div class="flex gap-4 mt-3">
                <div
                  class="card w-1/2"
                  :class="formData.privacy ? 'border-red-600/50 bg-base-200' : ''"
                  @click="formData.privacy = true"
                >
                  <div class="card-body">
                    <h3>🔒 Privé</h3>
            ...
            <div class="card-actions justify-end mt-6">
              <NuxtLink to="/groups" class="btn btn-ghost"> Annuler </NuxtLink>
