<template>
  <div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-8">
      <h1 class="text-3xl font-bold">Groupes</h1>
    ...
    <!-- Mes Groupes -->
    <section class="mb-12">
      <h2 class="text-2xl font-bold mb-4">Mes Groupes</h2>
    ...
    <!-- Groupes Publics -->
    <section>
      <h2 class="text-2xl font-bold mb-4">Groupes Publics</h2>
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          <template #actions>
            <NuxtLink :to="`/groups/${team.id}`" class="btn btn-ghost btn-sm">
              Voir
            </NuxtLink>
            <button 
            ...
            >
              <span v-if="joiningTeamId === team.id" class="loading loading-spinner loading-xs"></span>
    ...
    <div class="mt-8 text-center">
      <button @click="showJoinModal = true" class="btn btn-outline">
    ...
    <dialog :open="showJoinModal" class="modal" @click.self="showJoinModal = false">
      <div class="modal-box">
        ...
        <div class="modal-action">
          <button @click="showJoinModal = false" class="btn btn-ghost">Annuler</button>
          <button 
